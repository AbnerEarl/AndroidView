 ...
 */
package com.frank.ycj520.customview.banner.indicator;
...
public class DefaultIndicator extends BaseIndicator {
    ...
    protected void createIndicators(int itemCount) {
        ...
        LayoutParams lp = new LayoutParams(indicatorItemWidth == 0 ? LayoutParams.WRAP_CONTENT : indicatorItemWidth,
